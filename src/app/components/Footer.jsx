            ...
            <div className='flex flex-col space-y-4 sm:space-y-10 xl:space-y-16 px-3 lg:px-6 container mx-auto'>
                ...
                <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 justify-between mt-8">
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-sm text-white font-semibold sm:items-center">
                        ...
                        <button className='cursor-pointer group text-white flex items-center text-xl font-semibold hover:text-[var(--cta)] transition duration-300'>
                    ...
                    <div className="justify-end-safe">
                        <button className='group py-2.5 px-12 bg-[var(--cta)] cursor-pointer text-[var(--pastelbrown)] border-[0.0625rem] border-[var(--cta)] flex items-center rounded-full text-base lg:text-lg font-bold hover:bg-white hover:text-[var(--cta)] hover:border-[0.0625rem] hover:border-[var(--cta)] transition duration-300'>
                ...
                {/* right */}
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 mt-8 justify-between items-end">
                    <div className="">
                        <Image
                            src={logo}
                            alt="notionx Logo"
